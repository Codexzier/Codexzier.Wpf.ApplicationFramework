...
namespace WpfAppTemplateForNuget.Views.Dialog
{
    ...
    public partial class DialogView : UserControl
    {
        ...
        public DialogView()
        {
            ...
            this._viewModel.CommandSelectedPathDialogAccept =
                new ButtonCommandSelectedPathDialogAccept(this._viewModel);
        }

        private void BaseMessageEvent(IMessageContainer obj)
        {
            if (!(obj.Content is DataDialogContent dialogContent)) return;
